      ...
      >
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/3 bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl p-6 text-white shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-3">Flood Crisis in Southeast Asia</h3>
            <p className="mb-6 opacity-90">
              Catastrophic flooding has displaced thousands and destroyed critical infrastructure. 
              Your donation provides immediate relief including food, clean water, and medical supplies.
            </p>
          ...
          <div className="md:w-2/3">
            <div className="text-center mb-6">
              ...
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Emergency Relief Fund</h1>
              <p className="text-gray-600">Your support makes a direct impact in disaster-affected areas</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2">Quick Donation</label>
